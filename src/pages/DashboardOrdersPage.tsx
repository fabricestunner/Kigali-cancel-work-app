...
const ORDER_EXPORT_COLUMNS: ExportColumn<Order>[] = [
  ...
  { header: "Phone", value: (o) => String(o.phone_number), width: 16 },
  ...
  { header: "Delivery", value: (o) => o.delivery_option, width: 14 },
  { header: "Location", value: (o) => o.location, width: 24 },
  { header: "Buddy Group", value: (o) => o.buddy_group?.name ?? "—", width: 20 },
